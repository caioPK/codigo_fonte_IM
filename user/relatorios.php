<?php
  ...
  include("../conecta.php");
  $select = "SELECT e.CodJogo, j.Jogada, e.CodEquipe, j.FaseJogo from requipejogador r, equipe e, jogos j WHERE r.CodJogador = '".$_SESSION['usuarioID']."' AND r.CodEquipe = e.CodEquipe AND e.CodJogo = j.CodJogo";
  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="textousuario" style="padding-bottom: 10rem;">
        <h3>Jogada <?php echo $jogada; ?></h3>
        <h5 style="color: #324252; display: inline-block; margin-right: 1rem; font-size: 1rem;"> Vizualize o ranking na jogada:</h5>
              ...
              <?php
                ...
                <div id="tab1" class="tab active">
                  <div align=center>
                    ...
                    <table width=100% class="tabusuario" style="border-collapse:collapse;">     
                      <tr>
                        <th width=77%>Nome do lançamento</th>
                        <th width=23%>Valor</th>
                      </tr>
                      <tr> 
                        <td width=77%><p>Receita (P1*Q1+P2*Q2+P3*Q3+P4*Q4)</p></td>
                        <td width=23%><p>'.$Receita.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>Custo do Material Vendido (CMV)</p></td>
                        <td width=23%><p>'.$CMV.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>= '.$ResultadoBruto.'</p></td>
                        <td width=23%><p>'.$LucroLiquido.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Depreciação</p></td>
                        <td width=23%><p>'.$LucroBruto.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Salários Administrativos</p></td>
                        <td width=23%><p>'.$SalAdm.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- FGTS (8% salário bruto)</p></td>
                        <td width=23%><p>'.$FGTS.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- INSS (29% salário bruto)</p></td>
                        <td width=23%><p>'.$INSS.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- ICMS (4% do faturamento)</p></td>
                        <td width=23%><p>'.$ICMS.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- PIS (3,5% faturamento)</p></td>
                        <td width=23%><p>'.$PIS.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- COFINS (4% faturamento)</p></td>
                        <td width=23%><p>'.$COFINS.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Ociosidade </p></td>
                        <td width=23%><p>'.$Ociosidade.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Pesquisa e Desenvolvimento</p></td>
                        <td width=23%><p>'.$PeD.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Publicidade</p></td>
                        <td width=23%><p>'.$Publicidade.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Despesas Gerais (1,5% faturamento) </p></td>
                        <td width=23%><p>'.$DespesasGerais.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Custos de Estocagem ($30 por unidade restante)</p></td>
                        <td width=23%><p>'.$CustoEstocagem.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Qualidade</p></td>
                        <td width=23%><p>'.$Qualidade.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Marketing</p></td>
                        <td width=23%><p>'.$Marketing.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Energia Administrativo</p></td>
                        <td width=23%><p>'.$EnergiaAdm.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>= '.$ResultadoOperacional.'</p></td>
                        <td width=23%><p>'.$LucroOperacional.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>+ Receitas não-operacionais</p></td>
                        <td width=23%><p>'.$RecNaoOperacional.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- Despesas não operacionais</p></td>
                        <td width=23%><p>'.$DesNaoOperacional.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>'.$ResultadoSemIR.'</p></td>
                        <td width=23%><p>'.$LucroSemIR.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>- IRPJ</p></td>
                        <td width=23%><p>'.$IRPJ.'</p></td>
                      </tr>
                      <tr> 
                        <td width=77%><p>= '.$ResultadoLiquido.'</p></td>
                        <td width=23%><p>'.$LucroLiquido.'</p></td>
                      </tr>
                    </table>
                  </div>
                      ...
                      <tr>
                        <table class="tabusuario">
                          <tr>
                            ...
                            <td style="width: 20%;"><p>'.$impostosapagar.'</p></td>
                          </tr>
                        </table>    
                      </tr>
                      <tr>
